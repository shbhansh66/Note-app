  ...
  <button  onClick={() => setIsFormOpen(false)} className='w-6 h-6 bg-red-500 rounded-full flex items-center justify-center absolute right-5'>
        <X size={16} color="#f0ebeb" strokeWidth={1.75} />
            ...
            <div className='lg:w-1/2 w-full lg:p-10 p-5 flex flex-col gap-6 items-center h-full lg:border-l-2 border-gray-700 z-10 overflow-hidden '>
                ...
                <div className='scroll relative flex gap-4 flex-wrap justify-center w-full h-full overflow-y-auto overflow-x-hidden p-2 scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-900 scroll-smooth '> {/* Added custom scrollbar */}
    ...
    <button 
        ...
        <p className='text-gray-500 mt-1 p-1 text-sm leading-tight  font-medium  break-words whitespace-pre-wrap'>{elem.details}</p>
        </div>
                                </div>
                            );
                        })
